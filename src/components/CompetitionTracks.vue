...
const tracks = computed(() => [
  {
    id: 0,
    title: "01",
    name: t("competition-tracks.track1.title"),
    description: t("competition-tracks.track1.description"),
    icon: "blockchain",
  },
  {
    id: 1,
    title: "02",
    name: t("competition-tracks.track2.title"),
    description: t("competition-tracks.track2.description"),
    icon: "ai",
  },
  {
    id: 2,
    title: "03",
    name: t("competition-tracks.track3.title"),
    description: t("competition-tracks.track3.description"),
    icon: "both",
  },
]);
...
<template>
  ...
  >
    <div class="text-center mb-4 px-4 md:px-32">
      ...
      >
        {{ t("competition-tracks.description") }}
      </h3>
    </div>
      ...
      <CarouselContent class="gap-4 py-6 md:px-14 px-6 pb-12">
        ...
        >
          ...
          >
            <CardHeader class="pb-0">
              <div class="flex flex-col gap-2 p-4">
                <div class="flex items-start justify-between">
                  <div>
                    <CardTitle
                      class="text-[18px] font-bold md:text-[24px] text-primary"
                    >
                      {{ track.title }}
                      <br />
                      <span
            ...
            <CardContent
              class="p-10 pt-0 flex items-center justify-center text-justify"
            >
              <p class="text-sm md:text-[16px] text-muted-foreground text-left">
                {{ track.description }}
              </p>
            </CardContent>
          </Card>
    ...
    <div class="flex justify-center items-center gap-3">
      <Button
        ...
        variant="ghost"
        size="sm"
        class="h-10 w-10 rounded-full p-0 flex items-center justify-center ring-1"
        :class="
          idx === selectedIndex
